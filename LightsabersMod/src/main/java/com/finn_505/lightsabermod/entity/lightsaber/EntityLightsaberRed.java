...
public class EntityLightsaberRed extends EntityFlying implements IEntityOwnable{
	...
	public EntityLightsaberRed(World worldIn) {
		super(worldIn);
	...
	public EntityLightsaberRed(World worldIn, EntityPlayer Owner, boolean returnToOffHand)
	{
		super(worldIn);
		this.setSize(0.5F, 0.5F);
	...
	public void onLivingUpdate()
    {
        ...
        for(Entity e: closeEntities)
        {
        	if(!world.isRemote)
        	{
	        	if(!e.equals(this.getOwner()) 
	        			&& !(e instanceof EntityLightsaberRed) && !(e instanceof EntityLightsaberRed) 
	        	...
	        	else if(e.equals(this.getOwner()) && reachedDestination == true)
	        	{
	        		...
	        		{
	        			owner.setHeldItem(EnumHand.OFF_HAND, new ItemStack(ModItems.ITEM_IGNITEDREDLS, 1));
	        		}
	        		else
	        		{
	        			ItemHandlerHelper.giveItemToPlayer((EntityPlayer) this.getOwner(), new ItemStack(ModItems.ITEM_IGNITEDREDLS));
	        		}
	        	}
        	}
        }
    	...
    	{
    		this.setDead();
    		dropItem(ModItems.ITEM_REDLS, 1);
    	}
		...
		{
			this.setDead();
			dropItem(ModItems.ITEM_IGNITEDREDLS, 1);
		}
