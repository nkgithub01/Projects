...
public class EntityLightsaberBlue extends EntityFlying implements IEntityOwnable{
	...
	public EntityLightsaberBlue(World worldIn) {
		super(worldIn);
	...
	public EntityLightsaberBlue(World worldIn, EntityPlayer Owner, boolean returnToOffHand)
	{
		super(worldIn);
		this.setSize(0.5F, 0.5F);
	...
	public void onLivingUpdate()
    {
        ...
        for(Entity e: closeEntities)
        {
        	if(!world.isRemote)
        	{
	        	if(!e.equals(this.getOwner()) 
	        			&& !(e instanceof EntityLightsaberBlue) && !(e instanceof EntityLightsaberBlue) 
	        	...
	        	else if(e.equals(this.getOwner()) && reachedDestination == true)
	        	{
	        		...
	        		{
	        			owner.setHeldItem(EnumHand.OFF_HAND, new ItemStack(ModItems.ITEM_IGNITEDBLUELS, 1));
	        		}
	        		else
	        		{
	        			ItemHandlerHelper.giveItemToPlayer((EntityPlayer) this.getOwner(), new ItemStack(ModItems.ITEM_IGNITEDBLUELS));
	        		}
	        	}
        	}
        }
    	...
    	{
    		this.setDead();
    		dropItem(ModItems.ITEM_BLUELS, 1);
    	}
		...
		{
			this.setDead();
			dropItem(ModItems.ITEM_IGNITEDBLUELS, 1);
		}
