...
public class EntityLightsaber extends EntityFlying implements IEntityOwnable{
	...
	public EntityLightsaber(World worldIn) {
		super(worldIn);
	...
	public EntityLightsaber(World worldIn, EntityPlayer Owner, boolean returnToOffHand)
	{
		super(worldIn);
		this.setSize(0.5F, 0.5F);
	...
	public void onLivingUpdate()
    {
        ...
        for(Entity e: closeEntities)
        {
        	if(!world.isRemote)
        	{
	        	if(!e.equals(this.getOwner()) 
	        			&& !(e instanceof EntityLightsaber) && !(e instanceof EntityLightsaberBlue) 
	        	...
	        	else if(e.equals(this.getOwner()) && reachedDestination == true)
	        	{
	        		...
	        		{
	        			owner.setHeldItem(EnumHand.OFF_HAND, new ItemStack(ModItems.ITEM_IGNITEDGREENLS, 1));
	        		}
	        		else
	        		{
	        			ItemHandlerHelper.giveItemToPlayer((EntityPlayer) this.getOwner(), new ItemStack(ModItems.ITEM_IGNITEDGREENLS));
	        		}
	        	}
        	}
        }
    	...
    	{
    		this.setDead();
    		dropItem(ModItems.ITEM_GREENLS, 1);
    	}
		...
		{
			this.setDead();
			dropItem(ModItems.ITEM_IGNITEDGREENLS, 1);
		}
